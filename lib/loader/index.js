...
function load(file, options) {
  ...
  if (!imports.lib.log)
    imports.lib.log = function log(type, message) {
  ...
  module.array = {
    ...
    create: function(length, elementByteSize) {
      var ptr = (module.exports.malloc || imports.lib.malloc)(arrayHeaderSize + length * elementByteSize);
  ...
  module.string = {
    ...
    create: function(value) {
      var ptr = (module.exports.malloc || imports.lib.malloc)(arrayHeaderSize + (value.length << 1));
